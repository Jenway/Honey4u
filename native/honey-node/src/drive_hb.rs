    ...
    let nodes = node_jsons
        ...
        .map(|(pid, node_json)| -> Result<Value, String> {
            ...
            Ok(json!({
                ...
                "push_inbound_batch_calls": json_usize_field(&host_stats, "push_inbound_batch_calls")?,
                "push_inbound_batch_items": json_usize_field(&host_stats, "push_inbound_batch_items")?,
                "exchange_batches_calls": json_usize_field(&host_stats, "exchange_batches_calls")?,
                "exchange_inbound_items": json_usize_field(&host_stats, "exchange_inbound_items")?,
                "exchange_outbound_items": json_usize_field(&host_stats, "exchange_outbound_items")?,
                "pull_outbound_batch_calls": json_usize_field(&host_stats, "pull_outbound_batch_calls")?,
                "pull_outbound_batch_items": json_usize_field(&host_stats, "pull_outbound_batch_items")?,
                ...
                "exchange_deliver_seconds": json_f64_field(&host_stats, "exchange_deliver_seconds")?,
                "exchange_pump_seconds": json_f64_field(&host_stats, "exchange_pump_seconds")?,
                "exchange_drain_seconds": json_f64_field(&host_stats, "exchange_drain_seconds")?,
                "exchange_total_seconds": json_f64_field(&host_stats, "exchange_total_seconds")?,
            }))
        })
        .collect::<Result<Vec<_>, _>>()?;
