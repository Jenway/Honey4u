...
def _summary(batch_size: int, measured_tps: float, measured_ratio: float) -> BenchmarkSummary:
    return BenchmarkSummary(
        ...
        communication=CommunicationStats(
            ...
            proposal_available_events=30,
            proposal_available_payload_bytes=1800,
            proposal_available_proof_bytes=900,
        ...
        measured_communication=CommunicationStats(
            ...
            proposal_available_events=24,
            proposal_available_payload_bytes=1440,
            proposal_available_proof_bytes=720,
